...
var createGrid = function createGrid(graph, nodes, source, target, gridRatio) {
  ...
  var grid = new pathfinding.Grid(mapColumns, mapRows); // Update the grid representation with the space the nodes take up
...
function SmartEdge(_ref) {
  ...
  var FallbackEdge = options.fallback || reactFlowRenderer.BezierEdge;
  ...
  if (hasStringLabel) {
    edgeLabel = React__default["default"].createElement(reactFlowRenderer.EdgeText, {
      x: edgeCenterX,
      y: edgeCenterY,
      label: label,
...
var BezierConfiguration = {
  ...
  fallback: reactFlowRenderer.BezierEdge
};
function SmartBezierEdge(props) {
  var nodes = reactFlowRenderer.useNodes();
...
var StepConfiguration = {
  ...
  fallback: reactFlowRenderer.StepEdge
};
...
var StraightConfiguration = {
  ...
  fallback: reactFlowRenderer.StraightEdge
};
