...
async function fetchWrapper(requestOptions) {
  var _a3, _b, _c, _d, _e;
  const fetch = ((_a3 = requestOptions.request) == null ? void 0 : _a3.fetch) || globalThis.fetch;
  if (!fetch) {
    throw new Error(
...
async function getResponseData(response) {
  ...
  } else if (mimetype.type.startsWith("text/") || ((_a3 = mimetype.parameters.charset) == null ? void 0 : _a3.toLowerCase()) === "utf-8") {
    return response.text().catch(() => "");
  } else {
...
}, __publicField(_a2, "VERSION", VERSION14), _a2);
